...
- Stronger Android device targeting using Wireless Debugging
- Richer client UI state and response feedback
- Persistent device session history
- Screenshots and demo recordings for the portfolio site
